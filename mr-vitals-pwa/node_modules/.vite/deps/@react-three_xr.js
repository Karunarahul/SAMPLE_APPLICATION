...
// node_modules/@react-three/xr/node_modules/zustand/esm/index.js
...
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" && (((_a = window.document) == null ? void 0 : _a.createElement) || ((_b = window.navigator) == null ? void 0 : _b.product) === "ReactNative") ? React.useLayoutEffect : React.useEffect;
...
function XRManager({
  ...
  useIsomorphicLayoutEffect2(() => globalSessionStore.subscribe(({ session: session2 }) => set(() => ({ session: session2 }))), [gl.xr, set]);
  useIsomorphicLayoutEffect2(() => {
